...
public final class JDBCUtils {
    ...
    private static void config() {
        ...
        PropertyConfig propertyConfig =  PropertyConfig.PROPERTYCONFIG;

        /*
         * 获取驱动
         */
        driverClassName = propertyConfig.getStr("spring.datasource.druid.driverClassName");
        /*
         * 获取URL
         */
        URL = propertyConfig.getStr("spring.datasource.druid.url");
        /*
         * 获取用户名
         */
        username = propertyConfig.getStr("spring.datasource.druid.username");
        /*
         * 获取密码
         */
        password = propertyConfig.getStr("spring.datasource.druid.password");
        /*
    ...
    public static boolean execute(String SQL, Object... params) {
        ...
        if (ArrayUtil.isNotEmpty(params)) {
            ...
            try {
                ...
                System.out.println(prefix + " 失败: " + e.getMessage());
                rollback(c);
            }
    ...
    public static int insert(String SQL, boolean autoGeneratedKeys, List<Object> params) {
        ...
        if (CollUtil.isNotEmpty(params)) {
            ...
            Connection c = null;
            try {
                //从PreparedStatement 对象中获得它对应的连接对象
                c = ps.getConnection();
            } catch (SQLException e) {
                e.printStackTrace();
            }
